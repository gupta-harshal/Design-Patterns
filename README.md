...
For **system-style LLD interview prep** (Parking Lot, Elevator, Splitwise, LRU Cache, BookMyShow, and more), see the dedicated learning resource:

**[→ Low-Level Design Bible](./Low-Level-Design/)**

It includes foundations (how to approach LLD, SOLID, patterns map, interview checklist) plus 20+ full designs with explanations and runnable Java sketches.
